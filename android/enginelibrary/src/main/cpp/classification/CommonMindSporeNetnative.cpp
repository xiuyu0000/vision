...
#include "CommonMindSporeNetnative.h"
#include "MSNetWork.h"
...
Java_com_mindspore_enginelibrary_train_ClassificationTrain_loadCommonModel(JNIEnv *env,
                                                                    jobject thiz,
...
Java_com_mindspore_enginelibrary_train_ClassificationTrain_runCommonNet(JNIEnv *env,
                                                                 jobject type,
                                                                 jlong netEnv,
                                                                 jobject srcBitmap) {
...
Java_com_mindspore_enginelibrary_train_ClassificationTrain_unloadCommonModel(JNIEnv *env,
                                                                      jobject type,
                                                                      jlong netEnv) {
