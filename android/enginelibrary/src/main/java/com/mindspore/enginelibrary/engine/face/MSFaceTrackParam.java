...
public class MSFaceTrackParam {
    ...
    private static class FaceParamHolder {
        public static MSFaceTrackParam instance = new MSFaceTrackParam();
    }

    private MSFaceTrackParam() {
        reset();
    }

    public static MSFaceTrackParam getInstance() {
