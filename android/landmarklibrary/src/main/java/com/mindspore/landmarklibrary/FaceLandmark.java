...
//
    ...
    //左眉毛
    public static int leftEyebrowRightCorner = 21; // 左眉毛右边角
    public static int leftEyebrowLeftCorner = 17; // 左眉毛左边角
    public static int leftEyebrowLeftTopCorner = 18; // 左眉毛左顶角
    public static int leftEyebrowRightTopCorner = 20; // 左眉毛右顶角
    public static int leftEyebrowUpperMiddle = 19; // 左眉毛上中心
    public static int leftEyebrowLowerMiddle = 19; // 左眉毛下中心

    // 右眉毛
    public static int rightEyebrowRightCorner = 22; // 右眉毛右边角
    public static int rightEyebrowLeftCorner = 26; // 右眉毛左上角
    public static int rightEyebrowLeftTopCorner = 23; // 右眉毛左顶角
    public static int rightEyebrowRightTopCorner = 25; // 右眉毛右顶角
    public static int rightEyebrowUpperMiddle = 24; // 右眉毛上中心
    public static int rightEyebrowLowerMiddle = 24; // 右眉毛下中心

    // 左眼
//public static int leftEyeTop = 72; // 左眼球上边
//public static int leftEyeCenter = 74; // 左眼球中心
//public static int leftEyeBottom = 73; // 左眼球下边
    public static int leftEyeLeftCorner = 36; // 左眼左边角
    public static int leftEyeRightCorner = 39; // 左眼右边角

    // 右眼
//public static int rightEyeTop = 75; // 右眼球上边
//public static int rightEyeCenter = 77; // 右眼球中心
//public static int rightEyeBottom = 73; // 右眼球下边
    public static int rightEyeLeftCorner = 42; // 右眼左边角
    public static int rightEyeRightCorner = 45; // 右眼右边角

    public static int eyeCenter = 27; // 两眼中心

    // 鼻子
    public static int noseTop = 30; // 鼻尖
    public static int noseLeft = 31; // 鼻子左边
    public static int noseRight = 35; // 鼻子右边
    public static int noseLowerMiddle = 33; // 两鼻孔中心

    // 脸边沿
    public static int leftCheekEdgeCenter = 1; // 左脸颊边沿中心
    public static int rightCheekEdgeCenter = 15; // 右脸颊边沿中心

    // 嘴巴
    public static int mouthLeftCorner = 48; // 嘴唇左边
    public static int mouthRightCorner = 54; // 嘴唇右边
    public static int mouthUpperLipTop = 51; // 上嘴唇上中心
    public static int mouthUpperLipBottom = 62; // 上嘴唇下中心
    public static int mouthLowerLipTop = 66; // 下嘴唇上中心
    public static int mouthLowerLipBottom = 57; // 下嘴唇下中心

    // 下巴
    public static int chinLeft = 7; // 下巴左边
    public static int chinRight = 9; // 下巴右边
    public static int chinCenter = 8; // 下巴中心
...
//    public static int rightEyeBottom = 73; // 右眼球下边
    ...
    // 扩展的关键点(8个)
    public static int mouthCenter = 68; // 嘴巴中心
    public static int leftEyebrowCenter = 69; // 左眉心
    public static int rightEyebrowCenter = 70; // 右眉心
    public static int leftHead = 71; // 额头左侧
    public static int headCenter = 72; // 额头中心得到
    public static int rightHead = 73; // 额头右侧
    public static int leftCheekCenter = 74; // 左脸颊中心
    public static int rightCheekCenter = 75; // 右脸颊中心
