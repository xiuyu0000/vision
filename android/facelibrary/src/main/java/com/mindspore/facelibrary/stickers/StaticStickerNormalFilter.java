...
public class StaticStickerNormalFilter extends DynamicStickerBaseFilter {
        ...
        if (mStickerLoaderList.size() > 0) {
            for (int stickerIndex = 0; stickerIndex < mStickerLoaderList.size(); stickerIndex++) {
                synchronized (this) {
                    ...
                    calculateStickerVertices((StaticStickerNormalData)
                            mStickerLoaderList.get(stickerIndex).getStickerData());
    ...
    public void updateVideoVertexBuffer(int width, int height) {
        ...
        float stickerX = 0;
        float stickerY = 0;
        mVideoVertices[0] = stickerX;
        mVideoVertices[1] = stickerY;
        mVideoVertices[2] = stickerX + stickerWidth;
        mVideoVertices[3] = stickerY;
        mVideoVertices[4] = stickerX;
        mVideoVertices[5] = stickerY + stickerHeight;
        mVideoVertices[6] = stickerX + stickerWidth;
        mVideoVertices[7] = stickerY + stickerHeight;
        mVideoVertexBuffer.clear();
