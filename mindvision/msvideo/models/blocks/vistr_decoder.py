...
from mindvision.msvideo.utils.init_weight import UniformBias
from mindvision.msvideo.models.blocks.multihead_attention import MultiheadAttention
...
class TransformerDecoderLayer(nn.Cell):
    ...
    def construct(self, tgt, memory,
        ...
        tgt2 = self.self_attn(
            q, k, value=tgt, key_padding_mask=tgt_key_padding_mask)[0]
