...
from mindvision.msvideo.dataset.transforms import VideoCenterCrop, VideoNormalize
from mindvision.msvideo.dataset.transforms import VideoResize, VideoToTensor
from mindvision.msvideo.models.r2plus1d import r2plus1d18, r2plus1d50
...
if __name__ == '__main__':
    ...
    parser.add_argument('--ckpt_save_dir', type=str, default="./r2plus1d",
