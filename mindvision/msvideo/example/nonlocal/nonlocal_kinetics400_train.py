...
from mindvision.msvideo.dataset.transforms import VideoCenterCrop, VideoRandomHorizontalFlip
from mindvision.msvideo.dataset.transforms import VideoResize, VideoRescale, VideoReOrder, VideoNormalize
...
if __name__ == "__main__":
    ...
    parser.add_argument("--pretrained_model_dir", type=str,
                        default="/home/hcx/ms_nonlocal_dot_kinetics400.ckpt",
    ...
    parser.add_argument('--learning_rate', type=int, default=0.00375, help='Initial learning rate.')
    parser.add_argument('--milestone', type=list, default=[40, 80], help='A list of milestone.')
