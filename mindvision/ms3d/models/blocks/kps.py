...
class PointsObjClsModule(nn.Cell):
    ...
    def __init__(self, seed_feature_dim):
        ...
        self.conv1 = ms.nn.Conv1d(self.in_dim, self.in_dim, 1)
        self.bn1 = ms.nn.BatchNorm2d(self.in_dim)
        self.conv2 = ms.nn.Conv1d(self.in_dim, self.in_dim, 1)
        self.bn2 = ms.nn.BatchNorm2d(self.in_dim)
        self.conv3 = ms.nn.Conv1d(self.in_dim, 1, 1)
        self.relu = ops.ReLU()
