...
def mobilenet_v3_train(args_opt):
    """MobileNetV3 train."""
    ...
    # Create model.
    if args_opt.model == 'mobilenet_v3_small':
        from mindvision.classification.models import mobilenet_v3_small
        network = mobilenet_v3_small(args_opt.num_classes, pretrained=args_opt.pretrained)
    elif args_opt.model == 'mobilenet_v3_large':
        from mindvision.classification.models import mobilenet_v3_large
        network = mobilenet_v3_large(args_opt.num_classes, pretrained=args_opt.pretrained)
    ...
    ckpt_callback = ModelCheckpoint(prefix='mobilenet_v3',
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='MobileNetV3 train.')
    ...
    parser.add_argument('--ckpt_save_dir', type=str, default="./mobilenet_v3", help='Location of training outputs.')
